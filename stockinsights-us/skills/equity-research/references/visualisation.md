...
- Keep companies, fiscal periods, reporting granularity, statement scope, currency, units, and fiscal calendars comparable. Disclose material differences next to the output.
- Label derived metrics as `Derived` and apply the period, unit and derivation rules in `references/datasets/financial-statements.md`.
