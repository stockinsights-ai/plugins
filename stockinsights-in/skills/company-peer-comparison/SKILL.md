...
- Company-data reference: `../equity-research-workflow/references/datasets/company-data.md`
- Financial-metrics reference: `../equity-research-workflow/references/datasets/screen-financial-metrics.md`
...
1. Determine the universe:
   ...
   - Industry or sector: read `../equity-research-workflow/references/datasets/company-data.md`, map the classification, and call `filter_companies`.
...
6. Calculate derived values only after retrieval and under `../equity-research-workflow/references/datasets/screen-financial-metrics.md` and its linked calculation references.
